...
class TestAdapterInit:
    ...
    def test_create_agent_accepts_run_overrides(self, monkeypatch):
        captured = {}
        ...
        agent = adapter._create_agent(
            ...
            enabled_toolsets_override=["x_search", "web"],
            disabled_toolsets_override=["terminal", "browser"],
        )

        assert isinstance(agent, FakeAgent)
        assert captured["model"] == "gpt-5.5"
        assert captured["reasoning_config"] == {"enabled": True, "effort": "high"}
        assert captured["enabled_toolsets"] == ["x_search", "web"]
        assert captured["disabled_toolsets"] == ["terminal", "browser"]
